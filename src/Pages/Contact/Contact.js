...
const Contact = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center lg:text-left">
      ...
      <h4><i style={{fontSize:'30px'}} class="m-2 fa-solid fa-at"></i> <span className='text-green-600 font-bold'>iamparvezrahman@gmail.com</span></h4>
      <h4><i style={{fontSize:'30px'}} class="m-2 fa-solid fa-phone"></i> <span className='text-green-600 font-bold'>+8801686172299</span></h4>
